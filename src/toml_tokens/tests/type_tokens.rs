...
fn default_type_tokens_works() {
    ...
    let temp_targets_ts = temp_targets.type_tokens("temp_targets", &config, quote!(pub),&empty_derive);
...
fn configured_type_tokens_work() {
    ...
    let values_ident_ts = ports.type_tokens("ports", &values_ident_config, quote!(pub),&empty_derive);
    ...
    let prefer_slices_ts = ports.type_tokens("ports", &prefer_slices_config, quote!(pub),&empty_derive);
    ...
    let prefix_suffix_ts = title.type_tokens("title", &prefix_suffix_config, quote!(pub),&empty_derive);
    ...
    let prefix_suffix_ts2 = ports.type_tokens("ports", &prefix_suffix_config, quote!(pub),&empty_derive);
